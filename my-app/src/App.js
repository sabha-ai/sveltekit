...
function App() {
  const [files, setFiles] = React.useState(["studio","src", "financial_analyst_crew", "config"]);
  const breadcrumb_component = breadcrumb(files)
  return (
    <div style={{ display: 'flex' }}>
      <div style={{ display: 'flex', flexDirection: 'column', width: '100%', height: '529.6px', marginTop: '32px', overflowX: 'auto' }}>
        <div style={{ display: 'flex', flexDirection: 'row', backgroundColor: 'rgb(28, 28, 28)', paddingLeft: '8px', paddingRight: '8px', justifyContent: 'left', marginBottom: '8px', minHeight: '38px', color: 'rgb(181, 181, 181)', fontSize: '13px', overflowWrap: 'anywhere' }}>
            ...
            <div style={{ display: 'flex', flexFlow: 'row nowrap', width: 'auto', minWidth: '100%', WebkitBoxPack: 'start', justifyContent: 'flex-start', position: 'static', overflow: 'auto hidden', WebkitBoxAlign: 'stretch', alignItems: 'stretch', top: '0px', left: '0px', height: '483.6px', zIndex: 99, boxSizing: 'border-box' }}>
              ...
              <div data-collab-id="file-container" data-testid="file-container" style={{ height: '483.6px', zIndex: 100, borderRight: '0.8px solid rgb(54, 54, 54)', boxSizing: 'border-box', width: '480px', minWidth: '480px', paddingTop: '64px', background: 'rgb(28, 28, 28) none repeat scroll 0% 0% / auto padding-box border-box' }}>
                <div style={{ boxSizing: 'border-box', color: 'rgb(250, 250, 250)', height: '419.6px', minWidth: '100px', display: 'flex' }}>
                  <div style={{ position: 'relative', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', height: '419.6px', width: '240px', minWidth: '240px', maxWidth: '240px', boxShadow: 'rgb(54, 54, 54) -1px 0px 0px 0px inset' }}>
                    <div style={{ overflow: 'visible', height: '0px', width: '0px', boxSizing: 'border-box', outline: 'rgb(250, 250, 250) none 0px' }}>
                      <div aria-label="grid" aria-readonly="true" role="grid" tabIndex="0" style={{ boxSizing: 'border-box', direction: 'ltr', height: '420px', position: 'relative', width: '240px', willChange: 'transform', overflow: 'hidden', outline: 'rgb(250, 250, 250) none 0px' }}>
                        <div role="rowgroup" style={{ width: 'auto', height: '390px', maxWidth: '240px', maxHeight: '144px', overflow: 'auto hidden', position: 'relative', boxSizing: 'border-box', minHeight: 'calc(100% - 30px)', transform: 'matrix(1, 0, 0, 1, 0, 0)', outline: 'rgb(250, 250, 250) none 0px', overflowX: 'auto !important' }}>
                          <div data-testid="folder-nav-tree-item-.embedchain-selected" style={{ display: 'flex', flexDirection: 'row', minHeight: '24px', maxHeight: '24px', padding: '3px 4px 3px 16px', width: '100%', fontSize: '12px', textOverflow: 'ellipsis', overflow: 'hidden', whiteSpace: 'nowrap', WebkitBoxPack: 'justify', placeContent: 'center space-between', marginRight: '1px', zIndex: 99, fontWeight: 500, color: 'rgb(156, 156, 156)', height: '24px', left: '0px', position: 'absolute', top: '0px', cursor: 'pointer', verticalAlign: 'middle', lineHeight: '21px', background: 'rgb(31, 8, 64) none repeat scroll 0% 0% / auto padding-box border-box', animation: '0s ease-in-out 0.5s 1 normal forwards running fadeInCell', opacity: 1, boxSizing: 'border-box', minWidth: 'calc(100% - 2px)', outline: 'rgb(156, 156, 156) none 0px' }}>
                            <div style={{ boxSizing: 'border-box', display: 'flex', flexDirection: 'row', WebkitBoxPack: 'start', placeContent: 'center flex-start', maxWidth: '172px', outline: 'rgb(156, 156, 156) none 0px' }}><svg focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="FolderOpenIcon" style={{ boxSizing: 'border-box', userSelect: 'none', display: 'block', fill: 'rgb(156, 156, 156)', flexShrink: 0, transition: 'fill 0.2s cubic-bezier(0.4, 0, 0.2, 1) 0s', fontSize: '21px', width: '18px', height: '18px', marginRight: '6px', outline: 'rgb(156, 156, 156) none 0px' }}>
                              ...
                              <p style={{ boxSizing: 'border-box', margin: '0px', letterSpacing: '-0.18px', lineHeight: 'normal', fontFamily: 'Inter, Roboto, sans-serif', fontSize: '12px', maxWidth: '100%', paddingTop: '1px', display: 'block', fontWeight: 500, color: 'rgb(255, 255, 255)', overflowX: 'auto', whiteSpace: 'nowrap', outline: 'rgb(255, 255, 255) none 0px' }}>
                                <div style={{ boxSizing: 'border-box', textOverflow: 'ellipsis', overflow: 'hidden', whiteSpace: 'nowrap', WebkitBoxFlex: 1, flexGrow: 1, outline: 'rgb(255, 255, 255) none 0px' }}><span aria-label="" style={{ boxSizing: 'border-box', cursor: 'pointer', width: 'calc(100% - 48px)', outline: 'rgb(255, 255, 255) none 0px' }}>.embedchain</span></div>
                              </p>
                            </div>
                            <div style={{ boxSizing: 'border-box', display: 'flex', flexDirection: 'row', WebkitBoxPack: 'center', justifyContent: 'center', WebkitBoxAlign: 'center', alignItems: 'center', maxWidth: '172px', outline: 'rgb(156, 156, 156) none 0px' }}><svg focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="ArrowForwardIosIcon" style={{ boxSizing: 'border-box', userSelect: 'none', height: '21px', display: 'block', fill: 'rgb(156, 156, 156)', flexShrink: 0, transition: 'fill 0.2s cubic-bezier(0.4, 0, 0.2, 1) 0s', fontSize: '21px', width: '12px', outline: 'rgb(156, 156, 156) none 0px' }}>
                              <path d="M6.23 20.23 8 22l10-10L8 2 6.23 3.77 14.46 12z" style={{ boxSizing: 'border-box', outline: 'rgb(156, 156, 156) none 0px' }}></path>
                            </svg></div>
                          </div>
                          <div data-testid="folder-nav-tree-item-.lightning_studio" style={{ display: 'flex', flexDirection: 'row', minHeight: '24px', maxHeight: '24px', padding: '3px 4px 3px 16px', width: '100%', fontSize: '12px', textOverflow: 'ellipsis', overflow: 'hidden', whiteSpace: 'nowrap', WebkitBoxPack: 'justify', placeContent: 'center space-between', marginRight: '1px', zIndex: 99, fontWeight: 500, color: 'rgb(156, 156, 156)', height: '24px', left: '0px', position: 'absolute', top: '24px', cursor: 'pointer', verticalAlign: 'middle', lineHeight: '21px', animation: '0s ease-in-out 0.5s 1 normal forwards running fadeInCell', opacity: 1, boxSizing: 'border-box', minWidth: 'calc(100% - 2px)', outline: 'rgb(156, 156, 156) none 0px' }}>
                            <div style={{ boxSizing: 'border-box', display: 'flex', flexDirection: 'row', WebkitBoxPack: 'start', placeContent: 'center flex-start', maxWidth: '172px', outline: 'rgb(156, 156, 156) none 0px' }}><svg focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="FolderIcon" style={{ boxSizing: 'border-box', userSelect: 'none', display: 'block', fill: 'rgb(156, 156, 156)', flexShrink: 0, transition: 'fill 0.2s cubic-bezier(0.4, 0, 0.2, 1) 0s', fontSize: '21px', width: '18px', height: '18px', marginRight: '6px', outline: 'rgb(156, 156, 156) none 0px' }}>
                              ...
                              <p style={{ boxSizing: 'border-box', margin: '0px', letterSpacing: '-0.18px', lineHeight: 'normal', fontFamily: 'Inter, Roboto, sans-serif', fontSize: '12px', maxWidth: '100%', paddingTop: '1px', display: 'block', fontWeight: 400, color: 'rgb(181, 181, 181)', overflowX: 'auto', whiteSpace: 'nowrap', outline: 'rgb(181, 181, 181) none 0px' }}>
                                <div style={{ boxSizing: 'border-box', WebkitBoxFlex: 1, flexGrow: 1, textOverflow: 'ellipsis', overflow: 'hidden', whiteSpace: 'nowrap', outline: 'rgb(181, 181, 181) none 0px' }}><span aria-label="" style={{ boxSizing: 'border-box', cursor: 'pointer', width: 'calc(100% - 48px)', outline: 'rgb(181, 181, 181) none 0px' }}>.lightning_studio</span></div>
                              </p>
                            </div>
                            <div style={{ boxSizing: 'border-box', display: 'flex', flexDirection: 'row', WebkitBoxPack: 'center', justifyContent: 'center', WebkitBoxAlign: 'center', alignItems: 'center', maxWidth: '172px', outline: 'rgb(156, 156, 156) none 0px' }}><svg focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="ArrowForwardIosIcon" style={{ boxSizing: 'border-box', userSelect: 'none', height: '21px', display: 'block', fill: 'rgb(156, 156, 156)', flexShrink: 0, transition: 'fill 0.2s cubic-bezier(0.4, 0, 0.2, 1) 0s', fontSize: '21px', width: '12px', outline: 'rgb(156, 156, 156) none 0px' }}>
                              <path d="M6.23 20.23 8 22l10-10L8 2 6.23 3.77 14.46 12z" style={{ boxSizing: 'border-box', outline: 'rgb(156, 156, 156) none 0px' }}></path>
                          ...
                          <div data-testid="folder-nav-tree-item-src" style={{ boxSizing: 'border-box', display: 'flex', flexDirection: 'row', minHeight: '24px', maxHeight: '24px', padding: '3px 4px 3px 16px', width: '100%', fontSize: '12px', textOverflow: 'ellipsis', overflow: 'hidden', whiteSpace: 'nowrap', WebkitBoxPack: 'justify', placeContent: 'center space-between', marginRight: '1px', zIndex: 99, fontWeight: 500, color: 'rgb(156, 156, 156)', height: '24px', left: '0px', position: 'absolute', top: '48px', cursor: 'pointer', verticalAlign: 'middle', lineHeight: '21px', animation: '0s ease-in-out 0.5s 1 normal forwards running fadeInCell', opacity: 1, minWidth: 'calc(100% - 2px)', outline: 'rgb(156, 156, 156) none 0px' }}>
                            <div style={{ boxSizing: 'border-box', display: 'flex', flexDirection: 'row', WebkitBoxPack: 'start', placeContent: 'center flex-start', maxWidth: '172px', outline: 'rgb(156, 156, 156) none 0px' }}><svg focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="FolderIcon" style={{ boxSizing: 'border-box', userSelect: 'none', display: 'block', fill: 'rgb(156, 156, 156)', flexShrink: 0, transition: 'fill 0.2s cubic-bezier(0.4, 0, 0.2, 1) 0s', fontSize: '21px', width: '18px', height: '18px', marginRight: '6px', outline: 'rgb(156, 156, 156) none 0px' }}>
                              <path d="M10 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2h-8l-2-2z" style={{ boxSizing: 'border-box', outline: 'rgb(156, 156, 156) none 0px' }}></path>
                            </svg>
                              <p style={{ boxSizing: 'border-box', margin: '0px', letterSpacing: '-0.18px', lineHeight: 'normal', fontFamily: 'Inter, Roboto, sans-serif', fontSize: '12px', maxWidth: '100%', paddingTop: '1px', display: 'block', fontWeight: 400, color: 'rgb(181, 181, 181)', overflowX: 'auto', whiteSpace: 'nowrap', outline: 'rgb(181, 181, 181) none 0px' }}>
                                <div style={{ boxSizing: 'border-box', WebkitBoxFlex: 1, flexGrow: 1, textOverflow: 'ellipsis', overflow: 'hidden', whiteSpace: 'nowrap', outline: 'rgb(181, 181, 181) none 0px' }}><span aria-label="" style={{ boxSizing: 'border-box', cursor: 'pointer', width: 'calc(100% - 48px)', outline: 'rgb(181, 181, 181) none 0px' }}>src</span></div>
                              </p>
                            </div>
                            <div style={{ boxSizing: 'border-box', display: 'flex', flexDirection: 'row', WebkitBoxPack: 'center', justifyContent: 'center', WebkitBoxAlign: 'center', alignItems: 'center', maxWidth: '172px', outline: 'rgb(156, 156, 156) none 0px' }}><svg focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="ArrowForwardIosIcon" style={{ boxSizing: 'border-box', userSelect: 'none', height: '21px', display: 'block', fill: 'rgb(156, 156, 156)', flexShrink: 0, transition: 'fill 0.2s cubic-bezier(0.4, 0, 0.2, 1) 0s', fontSize: '21px', width: '12px', outline: 'rgb(156, 156, 156) none 0px' }}>
                              <path d="M6.23 20.23 8 22l10-10L8 2 6.23 3.77 14.46 12z" style={{ boxSizing: 'border-box', outline: 'rgb(156, 156, 156) none 0px' }}></path>
                  ...
                  <div style={{ position: 'relative', boxSizing: 'border-box', display: 'flex', flexDirection: 'column', height: '419.6px', width: '240px', minWidth: '240px', maxWidth: '240px', boxShadow: 'rgb(54, 54, 54) -1px 0px 0px 0px inset' }}>
                    <div style={{ overflow: 'visible', height: '0px', width: '0px', boxSizing: 'border-box', outline: 'rgb(250, 250, 250) none 0px' }}>
                      <div aria-label="grid" aria-readonly="true" role="grid" tabIndex="0" style={{ boxSizing: 'border-box', direction: 'ltr', height: '420px', position: 'relative', width: '240px', willChange: 'transform', overflow: 'hidden', outline: 'rgb(250, 250, 250) none 0px' }}>
                        <div role="rowgroup" style={{ width: 'auto', height: '390px', maxWidth: '240px', maxHeight: '24px', overflow: 'auto hidden', position: 'relative', boxSizing: 'border-box', minHeight: 'calc(100% - 30px)', transform: 'matrix(1, 0, 0, 1, 0, 0)', outline: 'rgb(250, 250, 250) none 0px', overflowX: 'auto !important' }}>
                          <div data-testid="file-column-item-config.json" style={{ display: 'flex', flexDirection: 'row', minHeight: '24px', maxHeight: '24px', padding: '3px 4px 3px 16px', width: '100%', fontSize: '12px', textOverflow: 'ellipsis', overflow: 'hidden', whiteSpace: 'nowrap', WebkitBoxPack: 'start', placeContent: 'center flex-start', marginRight: '1px', zIndex: 99, fontWeight: 500, color: 'rgb(156, 156, 156)', height: '24px', left: '0px', position: 'absolute', top: '0px', cursor: 'pointer', verticalAlign: 'middle', lineHeight: '21px', animation: '0s ease-in-out 0.5s 1 normal forwards running fadeInCell', opacity: 1, boxSizing: 'border-box', minWidth: 'calc(100% - 2px)', outline: 'rgb(156, 156, 156) none 0px' }}><span style={{ marginRight: '6px', boxSizing: 'border-box', outline: 'rgb(156, 156, 156) none 0px' }}><svg focusable="false" aria-hidden="true" viewBox="0 0 24 24" data-testid="InsertDriveFileIcon" style={{ userSelect: 'none', height: '21px', display: 'inline-block', fill: 'rgb(156, 156, 156)', flexShrink: 0, transition: 'fill 0.2s cubic-bezier(0.4, 0, 0.2, 1) 0s', fontSize: '21px', width: '18px', boxSizing: 'border-box', outline: 'rgb(156, 156, 156) none 0px' }}>
                            <path d="M6 2c-1.1 0-1.99.9-1.99 2L4 20c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6H6zm7 7V3.5L18.5 9H13z" style={{ boxSizing: 'border-box', outline: 'rgb(156, 156, 156) none 0px' }}></path>
                          </svg></span>
                            <div style={{ boxSizing: 'border-box', WebkitBoxFlex: 1, flexGrow: 1, maxWidth: '172px', outline: 'rgb(156, 156, 156) none 0px' }}><span aria-label="" style={{ boxSizing: 'border-box', cursor: 'pointer', width: 'calc(100% - 48px)', outline: 'rgb(156, 156, 156) none 0px' }}>
                              <div style={{ WebkitBoxFlex: 1, flexGrow: 1, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', boxSizing: 'border-box', outline: 'rgb(156, 156, 156) none 0px' }}>config.json</div>
                            </span></div>
                          </div>
                        </div>
                      </div>
